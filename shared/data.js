...
window.LSDV = {
  ente: {
    ...
    missione: "«L'uva 'e chella casa vecchia», dicevano a Pontelatone della vite ritrovata accanto a una masseria: da lì viene il nome Casavecchia. Qui però si produceva vino molto prima di quel nome, e ne scriveva già Plinio il Vecchio. Nella Vigna del Ventaglio di San Leucio i Borbone vollero il Pallagrello. Su storie come queste lavoriamo in rete negli otto comuni della DOC, con cantine, B&B, caseifici, amministrazioni e archivi, per divulgare la cultura dell'Alta Campania. Per noi il vino è il punto di partenza, e la vendita viene dopo.",
    intro: {
      a: "Il vino di quest'area ha una storia scritta, e noi la raccontiamo partendo dalle fonti. Plinio il Vecchio ne scrive nel libro XIV della Naturalis Historia. Nella Vigna del Ventaglio, che Ferdinando IV di Borbone fa impiantare a San Leucio, il Piedimonte rosso e bianco, oggi Pallagrello, occupa il quarto e il quinto raggio. Il decreto dell'8 novembre 2011 riconosce la DOC Casavecchia di Pontelatone in otto comuni. Per l'Anteprima 2026 ci ha ospitati l'Archivio di Stato di Caserta, nella Reggia.",
      b: "Le analisi chimico-fisiche di 50 vigneti hanno individuato tre macro aree di suolo. Depositi vulcanici intorno a Pontelatone, Vitric Andosols con vetri che luccicano al sole. Marne e arenarie sulla collina di Caiazzo. Sabbie alluvionali nel fondovalle del Volturno. Quando si segue la maturazione del Casavecchia nelle tre aree, l'analisi sensoriale registra profili diversi, con le note floreali che prevalgono sui depositi vulcanici e quelle balsamiche sulla collina. Il suolo si riconosce all'assaggio.",
      c: "Questa Strada la fanno le persone che vivono negli otto comuni della DOC. Ci sono diciassette aziende vitivinicole e, accanto a loro, B&B, caseifici, produttori di olio e di miele, enti locali. Insieme abbiamo disegnato tre percorsi, del Vino, dei Borghi e dei Sapori, per chi vuole conoscere le cantine, i paesi e i prodotti di questa zona. Se hai un ristorante, un agriturismo o un'enoteca, o se accompagni i visitatori come guida, puoi aderire anche tu: la tua attività avrà una scheda nella mappa e nei percorsi.",
      d: "Nella prima metà del Novecento un contadino di Pontelatone, Scirocco Prisco, interrò un tralcio di una vite antica e aspettò che mettesse radici. Da lì comincia la riscoperta del Casavecchia. Quel vitigno si coltiva oggi su tre suoli diversi, che le analisi di 50 vigneti hanno permesso di distinguere. Diciassette aziende vitivinicole fanno parte della Strada del Vino, insieme a chi gestisce un B&B, a chi produce formaggi e ai comuni della DOC."
    },
